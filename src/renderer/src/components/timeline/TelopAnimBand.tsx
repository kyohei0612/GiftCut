...
export function TelopAnimBand({
  ...
  // ——どのみち 2px の帯は掴めない。
  //
  // ※ **この1行を殺すと本当に赤くなることを確かめてある**（2026-08-03）。
  //   e2e「細すぎる演出の帯は作らない（寄せれば出てくる）」が
  //   `引いても細い帯が消えない（寄せた 1 → 引いた 1）` で落ちる。
  //   その確認は長らく `orderDependent` と `skipHere` で**二重に塞がっていて
  //   一度も走っていなかった**ので、走るようにしたうえで歯を確かめた。
